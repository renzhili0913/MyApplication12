...
import com.example.week1_03.Apis;
import com.example.week1_03.R;
import com.example.week1_03.ShowActivity;
import com.example.week1_03.bean.ChildBean;
import com.example.week1_03.presenter.IPresenterImpl;
...
public class ShopFragment extends Fragment implements IView {
    ...
    private void initData() {
        ...
        iPresenter.postRequestData(Apis.URl_DATA_DETAILS,params,ChildBean.class);
    }
    ...
    public void getDataSuccess(Object data) {
        if (data instanceof ChildBean){
            childBean = (ChildBean) data;
